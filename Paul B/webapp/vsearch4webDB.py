...
from DB_ContManager import UseDatabase, ConnectionError, CredentialsError,SQLError
...
def do_search() -> str:
    """Функция поиска в слове букв, совпадающих с введенным массивом"""
...
@app.route('/entry')
def entry_page() -> 'html':
    """Функция вызова начальной страницы веб приложения"""
...
def view_the_log() -> str:
    """Функция вывода журнала запросов"""
    try:
        with UseDatabase(app.config['dbconfig']) as cursor:
